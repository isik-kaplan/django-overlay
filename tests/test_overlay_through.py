"""An OverlayModel used as an M2M `through` table, per TODO/12.
...
def vendor_membership():
    ...
    stored already negated or it points at nothing. See TODO/15.
    """
...
def test_uuid_a_vendor_fk_points_at_the_vendor_row(uuid_vendor_membership):
    """The regression test for TODO/15, from the side that works."""
